...
class Hanoi5x4(SingleArmEnv):
    ...
    def _load_model(self):
        ...
        self.pegs_xy_pos = [[0.1, -0.25], [0.1, -0.10], [0.1, 0.05], [0.1, 0.20]]
        # Set pegs to be centered at xy pos (-0.1 x-axis, -0.05 y-axis shifted from the pegs_xy_pos)
        self.pegs_xy_center = [[0, -0.30, 0.8], [0, -0.15, 0.8], [0, 0.00, 0.8], [0, 0.15, 0.8]]
        self.peg_radius = 0.0
        
        cubes = [self.cube1, self.cube2, self.cube3, self.cube4, self.cube5]
        pegs = [self.visual_peg0, self.visual_peg1, self.visual_peg2, self.visual_peg3]
        self.objects = cubes + pegs
        self.obj_names = [obj.name for obj in self.objects]
        self.obj_map = {'cube1':self.cube1, 'cube2':self.cube2,'cube3':self.cube3, 'cube4':self.cube4, 'cube5':self.cube5}
        ...
        self.object_placements = {"cube1":None, "cube2":None, "cube3":None, "cube4":None, "cube5":None}
    ...
    def reset_positions(self, predicates):
        ...
        """
        self.object_placements = self.get_pos("cube5", predicates)
    ...
    def random_reset_f(self):
        ...
        list_choice1 = [object0_placement["cube5"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
        ...
        list_choice2 = [object0_placement["cube5"][0], object1_placement["cube4"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
        ...
        list_choice3 = [object0_placement["cube5"][0], object1_placement["cube4"][0], object2_placement["cube3"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
        ...
        list_choice4 = [object0_placement["cube5"][0], object1_placement["cube4"][0], object2_placement["cube3"][0], object3_placement["cube2"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
    ...
    def _reset_internal(self):
        ...
        if not self.deterministic_reset:
            ...
            if self.random_reset:
                ...
                object0_placement = self.placement_initializer0.sample(reference=object_base_placement["cube5"][0], on_top=True)
                object1_placement = self.placement_initializer1.sample(reference=object0_placement["cube4"][0], on_top=True)
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [cube1_pos, cube1_quat, cube2_pos, cube2_quat, cube3_pos, cube3_quat, cube4_pos, cube4_quat, cube5_pos, cube5_quat]
