...
class Hanoi4x4(SingleArmEnv):
    ...
    def reset_positions(self, predicates):
        ...
        """
        self.object_placements = self.get_pos("cube4", predicates)
    ...
    def random_reset_f(self):
        object0_placement = self.placement_initializer0.sample()
        # list all objects that cube3 can be placed on (including pegs)
        list_choice1 = [object0_placement["cube4"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
        object_1_ontop = list_choice1[np.random.randint(0, 4)]
        object1_placement = self.placement_initializer1.sample(reference=object_1_ontop, on_top=True)
        # list all objects that cube2 can be placed on (including pegs)
        list_choice2 = [object0_placement["cube4"][0], object1_placement["cube3"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
        ...
        list_choice3 = [object0_placement["cube4"][0], object1_placement["cube3"][0], object2_placement["cube2"][0], tuple(self.pegs_xy_center[0]), tuple(self.pegs_xy_center[1]), tuple(self.pegs_xy_center[2])]
    ...
    def _reset_internal(self):
        ...
        if peg_xy_jitter > 0:
            self.pegs_xy_center = [
                ...
                [base_pegs_xy_center[1][0] + np.random.uniform(-peg_xy_jitter, peg_xy_jitter), base_pegs_xy_center[1][1] + np.random.uniform(-peg_xy_jitter, peg_xy_jitter), base_pegs_xy_center[1][2]],
                [base_pegs_xy_center[2][0] + np.random.uniform(-peg_xy_jitter, peg_xy_jitter), base_pegs_xy_center[2][1] + np.random.uniform(-peg_xy_jitter, peg_xy_jitter), base_pegs_xy_center[2][2]],
                [base_pegs_xy_center[3][0] + np.random.uniform(-peg_xy_jitter, peg_xy_jitter), base_pegs_xy_center[3][1] + np.random.uniform(-peg_xy_jitter, peg_xy_jitter), base_pegs_xy_center[3][2]],
            ]
        else:
            self.pegs_xy_center = base_pegs_xy_center
