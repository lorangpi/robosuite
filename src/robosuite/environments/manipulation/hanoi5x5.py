...
class Hanoi5x5(SingleArmEnv):
    ...
    def _load_model(self):
        ...
        self.pegs_xy_pos = [[0.05, -0.25], [0.05, -0.10], [0.05, 0.05], [0.05, 0.20], [0.05, 0.35]]
        # Set pegs to be centered at xy pos (-0.1 x-axis, -0.05 y-axis shifted from the pegs_xy_pos)
        self.pegs_xy_center = [[-0.05, -0.30, 0.8], [-0.05, -0.15, 0.8], [-0.05, 0.00, 0.8], [-0.05, 0.15, 0.8], [-0.05, 0.30, 0.8]]
        self.peg_radius = 0.0
