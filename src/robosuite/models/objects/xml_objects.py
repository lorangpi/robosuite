...
class Cube1Object(MujocoXMLObject):
    """
...
class Cube2Object(MujocoXMLObject):
    """
    Cube1 box object (used in Hanoi)
    """
...
class Cube3Object(MujocoXMLObject):
    """
    Cube1 box object (used in Hanoi)
    """
...
class Cube4Object(MujocoXMLObject):
    """
    Cube1 box object (used in Hanoi)
    """
...
class PlateVisualObject(MujocoXMLObject):
    """
    Visual fiducial of square plate with a hole in the center (used in Hanoi)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/plate-with-hole-visual.xml"),
            name=name,
            joints=None,
            obj_type="visual",
            duplicate_collision_geoms=True,
